...
<body>
    ...
    <div class="gallery" onclick="openLightbox(event)">
        ...
        <img src="Images/MOVIE 6.jpg"
            alt="DANGAL">  
        <img src="Images/MOVIE 7.jpg"
            alt="BAJRANGI BHAIJAAN">
        <img src="Images/MOVIE 8.jpg"
            alt="BHOOTHNATH">  
        <img src="Images/MOVIE 9.jpg"
            alt="SAIYAARA">
        <img src="Images/MOVIE 10.jpg"
            alt="DEAR ZINDAGI">
        <img src="Images/MOVIE 11.jpg"
            alt="TRAIN TO BUSAN">
        <img src="Images/MOVIE 12.jpg"
            alt="MOM">
        <img src="Images/MOVIE 13.jpg"
            alt="ENGLISH VINGLISH">
        <img src="Images/MOVIE 14.jpg"
            alt="PK">
    </div>
...
## OUTPUT
![alt text](<Screenshot 2026-03-15 182021.png>)
![alt text](<Screenshot 2026-03-15 182105.png>)
![alt text](<Screenshot 2026-03-15 182444.png>)
